...
import ru.sbtqa.tag.pagefactoryexample.blocks.YandexMarket.RightMenuBlock;
...
public class YmNotebooksPage extends Page implements AbstractPage{
    ...
    @ElementTitle("Правое Меню")
    public RightMenuBlock rightMenuBlock;
